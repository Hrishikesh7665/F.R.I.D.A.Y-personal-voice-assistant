...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<strong>F.R.I</strong>.D.A.Y", None))
        ...
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<strong>Devoloped By</strong>: Hrishikesh Patra", None))
    # retranslateUi
