...
def youtube(query,des):
	...
	return "Showing Search Result For "+query+" In Youtube"+des

def youtube2(query,des):
	result = urllib.parse.quote(query)
	#"https://www.youtube.com/results?search_query=" + query
	#webbrowser.open('https://www.youtube.com/watch?v=' + results[0]['id'])
	webbrowser.open("https://www.youtube.com/results?search_query=" + result)
	return "Showing Search Result For "+query+" "+des
...
def email(rec_email=None, text="Hello, It's F.R.I.D.A.Y. here...", sub='F.R.I.D.A.Y.'):
	...
	s.starttls()
	print("enter2")
	s.login("paritosh.pgh.patra@gmail.com", "8240937665")
	message = 'Subject: {}\n\n{}'.format(sub, text)
	s.sendmail("paritosh.pgh.patra@gmail.com", rec_email, message)
	print("Sent")
	s.quit()
...
#email("hrishikesh.pgh.patra@gmail.com","How are you","wellcome")